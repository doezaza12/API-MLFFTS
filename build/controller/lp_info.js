...
async function getLpList(req, res, next) {
    try {
        let lp_list = await data_access_1.DAL.lpInfoDAL.getLpList(req['payload'].id, req.params.limit ? parseInt(req.params.limit) : 5, req.params.offset ? parseInt(req.params.offset) : 0);
